                                     ...
                                     <div class="form-group files">
                                        <label class="my-auto">Update Your Image </label>
                                         <input type="file"  id ='image'  class="form-control" {...register('image')} name ='image'  />
                                            ...
                                            <img src={`https://api1.carrent.website${carDetails.image}`} alt="Preview" width='120px' height='120px'/>
                                        <div>
                                            ...
                                            <img src={`https://api1.carrent.website${carDetails.image1}`} alt="Preview" width='120px' height='120px'/>



                                         <label class="my-auto">Upload Your File </label>
                                         <input id="image2" type="file" class="form-control"  {...register('image2')}  name ='image2' />
                                         <img src={`https://api1.carrent.website${carDetails.image2}`} alt="Preview" width='120px' height='120px'/>


                                         <label class="my-auto">Upload Your File </label>
                                         <input id="image3" type="file" class="form-control"   {...register('image3')}   name ='image3' />
                                         <img src={`https://api1.carrent.website${carDetails.image3}`} alt="Preview" width='120px' height='120px'/>
