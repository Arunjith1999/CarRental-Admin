...
import { categoryPost } from '../../../utils/Constants'
...
const AddCategory = () => {
    ...
    const onSubmit = async(data) =>{
        axios.post(categoryPost,data).then((res)=>{
            if (res.data.status === 'Category Added'){
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-5 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="Mobile-Number">Category Name</label>
