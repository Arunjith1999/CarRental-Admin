                                ...
                                <div class="col-md-12 col-lg-10 col-12">
                                    <h4 style={{textAlign:'center',marginTop:'2rem'}}> Image of the Car</h4>
                                         <div class="card" style={{width: '18rem'}}>
                                            <img class="card-img-top" src={`https://api1.carrent.website${carDetails.image}`} alt="Card image cap"/>
                                            <div class="card-body">
                                        ...
                                        <div className=' row col-md-12'>
                                            <div className='col-md-4'>
                                                ...
                                                <img class="card-img-top" src={`https://api1.carrent.website${carDetails.image1}`} alt="Card image cap"/>
                                                <div class="card-body">
                                            ...
                                            <div className='col-md-4'>
                                              <div class="card" style={{width: '12rem'}}>
                                                <img class="card-img-top" src={`https://api1.carrent.website${carDetails.image2}`} alt="Card image cap"/>
                                                <div class="card-body">
                                            ...
                                            <div className='col-md-4'>
                                              <div class="card" style={{width: '12rem'}}>
                                                <img class="card-img-top" src={`https://api1.carrent.website${carDetails.image3}`} alt="Card image cap"/>
                                                <div class="card-body">
                                        ...
                                        <div class="card" style={{width: '18rem'}}>
                                                <img class="card-img-top" src={`https://api1.carrent.website${carDetails.image4}`} alt="Card image cap"/>
                                                <div class="card-body">
